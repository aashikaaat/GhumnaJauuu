...
label1 = CTkLabel(master=root, text="Destination: Nagarkot", font=("Jost", 30,"bold"), text_color="#000000", fg_color="#FFFFFF")
...
#nagarkot
nagarkot_btn=CTkButton(master=root, text="Nagarkot",font=("Inter",28, "bold"),text_color="#FFFFFF",fg_color="#738600",hover_color="#000000",bg_color="#99B104", corner_radius=0)
...
label1 = CTkLabel(master=root, text="Himalayn Range View Hotel", font=("Jost", 20), text_color="#000000", fg_color="#FFFFFF")
label1.place(x=375, y=630, w=320, h=50)
