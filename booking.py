...
#Booking
clientid_btn=CTkButton(master=root, text="Booking",font=("Inter",28, "bold"),text_color="#FFFFFF",fg_color="#738600",hover_color="#000000",bg_color="#99B104", corner_radius=0)
...
#Booking Info
label1 = CTkLabel(master=root, text="Booking Information", font=("Jost", 28,"bold"), text_color="#000000", fg_color="#FFFFFF")
label1.place(x=360, y=320, w=450, h=64)
...
# Table
table=ttk.Treeview(frame3, columns=('first','last','ph. no','date'),show='headings')
