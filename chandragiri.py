...
pil_image1=Image.open("chandragiri.png")#insert image
...
#dhulikhel
dhulikhel_btn=CTkButton(master=root, text="Dhulikhel",font=("Inter",28, "bold"),text_color="#FFFFFF",fg_color="#99B104",hover_color="#738600",bg_color="#99B104", corner_radius=0,command=dhulikhel)
