...
label1 = CTkLabel(master=root, text="Destination: Chandragiri", font=("Jost", 30,"bold"), text_color="#000000", fg_color="#FFFFFF")
label1.place(x=310, y=220, w=440, h=64)

pil_image1=Image.open("mapnagarkot.png")#insert image
...
frame.place(x =1150,y =280, w=396, h=653)
frame=customtkinter.CTkFrame(master=root, fg_color="#FFFFFF", bg_color="#FFFFFF")
frame.place(x =1160,y =670, w=370, h=10)


#nagarkot
nagarkot_btn=CTkButton(master=root, text="Nagarkot",font=("Inter",28, "bold"),text_color="#FFFFFF",fg_color="#99B104",hover_color="#738600",bg_color="#99B104", corner_radius=0)
nagarkot_btn.place(x=0, y=250, w=380,h=117)
nagarkot_indicate=tk.Label( bg="#FFFFFF")
nagarkot_indicate.place(x=0, y=315, w=8, h=117)

#dhulikhel
dhulikhel_btn=CTkButton(master=root, text="Dhulikhel",font=("Inter",28, "bold"),text_color="#FFFFFF",fg_color="#99B104",hover_color="#738600",bg_color="#99B104", corner_radius=0)
...
#shivapuri
shivapuri_btn=CTkButton(master=root, text="Shivapuri",font=("Inter",28, "bold"),text_color="#FFFFFF",fg_color="#99B104",hover_color="#738600",bg_color="#99B104", corner_radius=0)
...
#Chitlang
Chitlang_btn=CTkButton(master=root, text="Chitlang",font=("Inter",28, "bold"),text_color="#FFFFFF",fg_color="#99B104",hover_color="#738600",bg_color="#99B104", corner_radius=0)
Chitlang_btn.place(x=0, y=529, w=380,h=117)
Chitlang_indicate=tk.Label( bg="#FFFFFF")
Chitlang_indicate.place(x=0, y=662, w=8, h=117)

#chandragiri
Chandragiri_btn=CTkButton(master=root, text="Chandragiri",font=("Inter",28, "bold"),text_color="#FFFFFF",fg_color="#738600",hover_color="#000000",bg_color="#99B104", corner_radius=0)
...
label1 = CTkLabel(master=root, text="27.2 Kms (16.9 miles)", font=("Jost", 20,), text_color="#000000", fg_color="#FFFFFF")
label1.place(x=410, y=510, w=250, h=50)
...
label1 = CTkLabel(master=root, text="Chandragiri Resort", font=("Jost", 20), text_color="#000000", fg_color="#FFFFFF")
label1.place(x=375, y=630, w=230, h=50)
...
label1 = CTkLabel(master=root, text="Yoga, Hike and Himalayan Range View", font=("Jost", 20), text_color="#000000", fg_color="#FFFFFF")
label1.place(x=390, y=700, w=460, h=50)
...
label1.place(x=1160, y=300, w=150, h=50)

# Pathao Fare:   600
label1 = CTkLabel(master=root, text="Pathao Fare:    600 -", font=("Jost", 17,"bold"), text_color="#FFFFFF", fg_color="#3F452F")
label1.place(x=1160, y=350, w=300, h=50)

# Hotel     :   4300
label1 = CTkLabel(master=root, text="Hotel           :    4300 -", font=("Jost", 17,"bold"), text_color="#FFFFFF", fg_color="#3F452F")
label1.place(x=1160, y=400, w=300, h=50)

# Activity     :   1400
label1 = CTkLabel(master=root, text="Activity       :    1400 -", font=("Jost", 17,"bold"), text_color="#FFFFFF", fg_color="#3F452F")
...
label1.place(x=1160, y=500, w=300, h=50)

# Total     :   6650
label1 = CTkLabel(master=root, text="Total           :    6650 -", font=("Jost", 17,"bold"), text_color="#FFFFFF", fg_color="#3F452F")
label1.place(x=1160, y=690, w=300, h=50)
