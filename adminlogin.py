...
#Admin Login 
label1 = CTkLabel(master=root, text="Admin Log In", font=("Britannic Bold", 35), text_color="#000000", fg_color="#FCD419")
label1.place(x=970, y=50, w=280, h=80)
...
#login button
btn=CTkButton(master=root, text="Log in",font=("Calibri",19, "bold"),text_color="#FFFFFF",fg_color="#000000",bg_color="#FCD419",command=client)
