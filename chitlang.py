...
#Destination: Chitlang
label1 = CTkLabel(master=root, text="Destination: Chitlang", font=("Jost", 30,"bold"), text_color="#000000", fg_color="#FFFFFF")
...
#Chitlang
Chitlang_btn=CTkButton(master=root, text="Chitlang",font=("Inter",28, "bold"),text_color="#FFFFFF",fg_color="#738600",hover_color="#000000",bg_color="#99B104", corner_radius=0)
Chitlang_btn.place(x=0, y=529, w=380,h=117)
Chitlang_indicate=tk.Label( bg="#FFFFFF")
Chitlang_indicate.place(x=0, y=662, w=8, h=117)

#chandragiri
Chandragiri_btn=CTkButton(master=root, text="Chandragiri",font=("Inter",28, "bold"),text_color="#FFFFFF",fg_color="#99B104",hover_color="#738600",bg_color="#99B104", corner_radius=0)
...
label1 = CTkLabel(master=root, text="29 Kms (19 miles)", font=("Jost", 20,), text_color="#000000", fg_color="#FFFFFF")
label1.place(x=410, y=510, w=220, h=50)
...
label1 = CTkLabel(master=root, text="Kulekhani View Resort", font=("Jost", 20), text_color="#000000", fg_color="#FFFFFF")
label1.place(x=375, y=630, w=270, h=50)
...
label1 = CTkLabel(master=root, text="Yoga, Hike and Boating", font=("Jost", 20), text_color="#000000", fg_color="#FFFFFF")
label1.place(x=390, y=700, w=300, h=50)
...
# Pathao Fare:   1200
label1 = CTkLabel(master=root, text="Pathao Fare:    1200 -", font=("Jost", 17,"bold"), text_color="#FFFFFF", fg_color="#3F452F")
...
# Activity     :   1400
label1 = CTkLabel(master=root, text="Activity       :    1200 -", font=("Jost", 17,"bold"), text_color="#FFFFFF", fg_color="#3F452F")
...
# Total     :   4300
label1 = CTkLabel(master=root, text="Total           :    7050-", font=("Jost", 17,"bold"), text_color="#FFFFFF", fg_color="#3F452F")
