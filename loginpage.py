...
#username
label7 = CTkLabel(master=root, text="Username:", font=("Archivo", 15), text_color="#000000", fg_color="#FCD419")
label7.place(x=960, y=110, w=150, h=50)
entry1=CTkEntry(master=root, placeholder_text="Enter your username",fg_color="#000000",bg_color="#FCD419")
...
#login button
btn=CTkButton(master=root, text="Log in",font=("Calibri",19, "bold"),text_color="#FFFFFF",fg_color="#000000",bg_color="#FCD419")
btn.place(x=1350, y=220, w=132,h=34)

# forgot password
btn=CTkButton(master=root, text="Forgot password?",font=("Archivo",13,"underline"),text_color="#000000",fg_color="#FCD419",bg_color="#FCD419", hover_color="#FCD419")
