...
#Hotels
hotel_btn=CTkButton(master=root, text="Hotels",font=("Inter",28, "bold"),text_color="#FFFFFF",fg_color="#738600",hover_color="#000000",bg_color="#99B104", corner_radius=0)
...
# Table
table=ttk.Treeview(frame3, columns=('first','last','ph. no','date', 'location'),show='headings')
