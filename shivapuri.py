...
label1 = CTkLabel(master=root, text="Destination: Shivapuri", font=("Jost", 30,"bold"), text_color="#000000", fg_color="#FFFFFF")
...
#shivapuri
shivapuri_btn=CTkButton(master=root, text="Shivapuri",font=("Inter",28, "bold"),text_color="#FFFFFF",fg_color="#738600",hover_color="#000000",bg_color="#99B104", corner_radius=0)
...
label1 = CTkLabel(master=root, text="26 Kms (16.3 miles)", font=("Jost", 20,), text_color="#000000", fg_color="#FFFFFF")
...
label1 = CTkLabel(master=root, text="Fulbari Resort", font=("Jost", 20), text_color="#000000", fg_color="#FFFFFF")
label1.place(x=370, y=630, w=170, h=50)
...
label1 = CTkLabel(master=root, text="Yoga, Hike", font=("Jost", 20), text_color="#000000", fg_color="#FFFFFF")
...
# Hotel     :   4170
label1 = CTkLabel(master=root, text="Hotel           :    4170 -", font=("Jost", 17,"bold"), text_color="#FFFFFF", fg_color="#3F452F")
...
# Total     :   7120
label1 = CTkLabel(master=root, text="Total           :    7120 -", font=("Jost", 17,"bold"), text_color="#FFFFFF", fg_color="#3F452F")
