...
label1 = CTkLabel(master=root, text="Transport Booking Information", font=("Jost", 28,"bold"), text_color="#000000", fg_color="#FFFFFF")
label1.place(x=390, y=320, w=520, h=64)
...
# Table
table=ttk.Treeview(frame3, columns=('first','last','ph. no','location','date', 'time'),show='headings')
