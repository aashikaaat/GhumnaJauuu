...
combobox3= CTkComboBox(master=root, values=["Bhaktapur","Kathmandu","Kavre","Lalitpur","Makwanpur","Nuwakot"],bg_color="#FFFFFF", fg_color="#FFFFFF", text_color="#000000")
...
#location entry box
combobox1= CTkComboBox(master=root, values=["Bhaktapur","Kathmandu","Kavre","Lalitpur","Makwanpur","Nuwakot"],bg_color="#bec40a")
combobox1.set('Select here.')
combobox1.place(x=220, y=400, w=400, h=30)

# time you have allocated
label6 = CTkLabel(master=root, text="Time you have allocated", font=("Be Vietnam", 18,"bold"), text_color="#000000", fg_color="#bec40a", bg_color="#000000")
label6.place(x=215, y=440, w=270, h=38)
...
#transport entry box
combobox2= CTkComboBox(master=root, values=["Own Ride","Pathao Bike","Pathao Taxi","Public Bus"],bg_color="#bec40a")
...
btn=CTkButton(master=root, text="Submit",font=("Archivo",25,"bold"),text_color="#FFFFFF",fg_color="#000000",bg_color="#bec40a",hover_color="#3BC100")
